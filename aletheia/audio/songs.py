...
TITLE = {
    ...
    "channels": {
        ...
        "lyre": {"inst": "lyre", "vol": 0.3, "rev": 0.45, "pan": 0.35,
...
STAGE2 = {
    ...
    "channels": {
        "lead": {"inst": "lead", "vol": 0.36, "rev": 0.25, "echo": (3, 0.3), "lp": 5500,
                 "params": {"vib": 10}},
        "lead2": {"inst": "bell", "vol": 0.22, "rev": 0.35, "oct": 1, "pan": 0.35},
        "pad": {"inst": "strings", "chords": True, "vol": 0.24, "rev": 0.45, "duck": 0.4},
        ...
        "drums": {"drums": True, "vol": 0.6, "rev": 0.12},
        "perc": {"drums": True, "vol": 0.4, "pan": -0.4, "rev": 0.25},
    },
}
...
STAGE4 = {
    ...
    "channels": {
        "lead": {"inst": "brass", "vol": 0.44, "rev": 0.25, "echo": (3, 0.2), "params": {"a": 0.02}},
        ...
        "bass": {"inst": "fmbass", "vol": 0.55, "lp": 2600, "params": {"index": 4.0}},
        "drums": {"drums": True, "vol": 0.64, "rev": 0.1},
...
STAGE5 = {
    ...
    "channels": {
        "lead": {"inst": "bell", "vol": 0.34, "rev": 0.55, "echo": (6, 0.35), "params": {"decay": 0.9}},
...
STAGE6 = {
    ...
    "channels": {
        "lead": {"inst": "brass", "vol": 0.46, "rev": 0.35, "params": {"a": 0.03}},
...
BOSS = {
    ...
    "channels": {
        "lead": {"inst": "lead", "vol": 0.4, "rev": 0.2, "echo": (3, 0.22), "lp": 6000, "params": {"vib": 12}},
        "lead2": {"inst": "brass", "vol": 0.26, "rev": 0.25, "oct": -1, "pan": -0.3},
        "pad": {"inst": "strings", "chords": True, "vol": 0.24, "rev": 0.35, "duck": 0.55},
        "arp": {"inst": "pulse", "vol": 0.15, "pan": 0.4, "echo": (2, 0.25),
                "params": {"duty": 0.25, "decay": 0.05},
                "autoarp": {"pattern": [0, 1, 2, 3, 2, 1], "rate": 1, "oct": 5}},
        "bass": {"inst": "fmbass", "vol": 0.55, "lp": 3200, "params": {"index": 3.8}},
        "drums": {"drums": True, "vol": 0.66, "rev": 0.1},
    },
    "drive": 1.35,
}
...
FINAL = {
    ...
    "channels": {
        "lead": {"inst": "brass", "vol": 0.44, "rev": 0.3, "params": {"a": 0.02}},
        ...
        "drums": {"drums": True, "vol": 0.64, "rev": 0.12},
